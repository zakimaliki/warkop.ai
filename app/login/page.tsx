        ...
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#f9f6e2] to-[#e9dbc7]">
            <div className="flex flex-col items-center w-full">
                ...
                <div className="flex flex-col items-center mb-6">
                    ...
                    <p className="mt-2 text-sm text-[#a67c52]">Masuk dulu, biar bisa ngopi bareng cari kerja <span role="img" aria-label="smile">😋</span></p>
                </div>
                {/* Card */}
                <div className="bg-white/90 rounded-xl shadow-lg px-8 py-8 w-full max-w-sm flex flex-col items-center">
                    ...
                    <form className="w-full flex flex-col gap-4">
                        ...
                        <Button type="submit" className="mt-2 bg-[#944C1F] hover:bg-[#7a3d18] text-white font-semibold flex items-center gap-2 w-full">
